...
public class RecordedActivity extends BaseActivity {
    ...
    //最大录制时间
    private int maxDuration = 20*1000;
    //本次段落是否录制完成
        ...
        iv_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isVideoData) {
                    ...
                    intent.putExtra("path", SDKUtil.VIDEO_PATH + "/wx_recorded_videoFile.mp4");
    ...
    private void syntVideo(){
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                String output = SDKUtil.VIDEO_PATH+"/wx_recorded_videoFile.mp4";
