package com.iit.yk.chat_base_component.imuisample.messages;
...
public class MessageListActivity extends Activity implements View.OnTouchListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatView.setTitle("ChatUI 组件封装");
        initMsgAdapter();
        ...
        mChatView.setMenuClickListener(new OnMenuClickListener() {
            ...
            public void onSendFiles(List<FileItem> list) {
                ...
                for (FileItem item : list) {
                    if (item.getType() == FileItem.Type.Image) {
                        ...
                        message = new MyMessage(null, IMessage.MessageType.RECEIVE_VIDEO.ordinal());
            ...
            public boolean switchToMicrophoneMode() {
                ...
                if (!EasyPermissions.hasPermissions(MessageListActivity.this, perms)) {
                    EasyPermissions.requestPermissions(MessageListActivity.this,
                            getResources().getString(R.string.chat_base_rationale_record_voice),
            ...
            public boolean switchToGalleryMode() {
                ...
                if (!EasyPermissions.hasPermissions(MessageListActivity.this, perms)) {
                    EasyPermissions.requestPermissions(MessageListActivity.this,
                            getResources().getString(R.string.chat_base_rationale_photo),
                            RC_PHOTO, perms);
                }
            ...
            public boolean switchToCameraMode() {
                ...
                if (!EasyPermissions.hasPermissions(MessageListActivity.this, perms)) {
                    EasyPermissions.requestPermissions(MessageListActivity.this,
                            getResources().getString(R.string.chat_base_rationale_camera),
                            RC_CAMERA, perms);
                    return false;
                } else {
            ...
            public void onOpenCamera() {
                Intent intent = new Intent(MessageListActivity.this, RecordedActivity.class);
                startActivityForResult(intent, REQUEST_CODE_RECORDED_VIDEO);
            }
        });
...
//                }
            ...
            public void onMessageClick(MyMessage message) {
                ...
                if (message.getType() == IMessage.MessageType.RECEIVE_VIDEO.ordinal()
                    ...
                    Toast.makeText(getApplicationContext(),
                            getApplicationContext().getString(R.string.chat_base_message_click_hint),
        ...
        mAdapter.setOnAvatarClickListener(new MsgListAdapter.OnAvatarClickListener<MyMessage>() {
            ...
            public void onAvatarClick(MyMessage message) {
                ...
                Toast.makeText(getApplicationContext(),
                        getApplicationContext().getString(R.string.chat_base_avatar_click_hint),
                        Toast.LENGTH_SHORT).show();
                // do something
            }
        });
        ...
        layout.setPtrHandler(new PtrHandler() {
            ...
            public void onRefreshBegin(PullToRefreshLayout layout) {
                ...
                ToastUtils.showShort("Loading next page");
